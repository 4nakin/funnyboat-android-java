...
public class Game implements SurfaceHolder.Callback, Runnable, View.OnTouchListener {
	...
	public void resume() {
		synchronized(resumeBarrier) { resumeBarrier.notifyAll(); }
	}
	public void waitForResume() throws InterruptedException {
		synchronized(resumeBarrier) { resumeBarrier.wait(); }
	}
	public void run() {
		try {
			while(true) {
