...
public class Water {
	...
	int height = 800;
	{
		clouds[0] = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.cloud1);
		clouds[1] = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.cloud2);
		clouds[2] = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.cloud3);
		clouds[3] = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.cloud4);
		cloudsX[0] = 30;
		cloudsX[1] = 430;
		cloudsX[2] = 40;
		cloudsX[3] = 500;
	...
	void tick() {
		...
		for(int i=0; i<4; i++) {
			...
			Game.canvas.drawBitmap(clouds[i], cloudsX[i] - 120, height - 60, null);
		} 
		int skip = 2;
