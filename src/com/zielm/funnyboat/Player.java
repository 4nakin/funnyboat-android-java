...
public class Player extends GameObject {
	...
	Bitmap heartEmpty;
	{
		img = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.laiva);
		heartFull = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.sydan_f);
		heartEmpty = BitmapFactory.decodeResource(Game.app.getResources(), R.drawable.sydan_tyhja);
	}
	Bitmap getImage() {
		return img;
	}
	...
	public void tick() {
		...
		Game.canvas.drawText("Score: " + Gameplay.current.score, 5, 50, Menu.smallTextPaint);
